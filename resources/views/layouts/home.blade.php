...
<html lang="en">
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
              ...
              <ul class="collapse list-unstyled" id="InboundSubmenu">
                <li>
                    <a href="{{route('scan-in')}}">Inbound</a>
                </li>
                <li>
                    <a href="{{route('inbound-list')}}">Inbound List</a>
                </li>
              </ul>
	          </li>
			  <li>
              ...
              <ul class="collapse list-unstyled" id="OutboundSubmenu">
                <li>
                    <a href="{{route('scan-out')}}">Outbound</a>
                </li>
                <li>
                    <a href="{{route('outbound-list')}}">Outbound List</a>
                </li>
              </ul>
	          </li>
	          <li>
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <h2 class="mb-4">Wahyu Manunggal</h2>
